class UI < Sprite
  def initialize
    ...
    # イメージの大きさはhomeを基準にしているので注意
    @@img_width = @@home_img.width
    @@img_height = @@home_img.height
    ...
    @@home_button = [Sprite.new(@@img_margin, @@buttons_y, @@home_img), Sprite.new(@@img_margin, @@buttons_y, @@home_img.flush([50, 50, 50]))]
    @@shop_button = [Sprite.new(@@img_margin * 2 + @@img_width, @@buttons_y, @@shop_img), Sprite.new(@@img_margin * 2 + @@img_width, @@buttons_y, @@shop_img.flush([50, 50, 50]))]
    @@explore_button = [Sprite.new(@@win_w - @@img_margin - @@img_width, @@buttons_y, @@explore_img), Sprite.new(@@win_w - @@img_margin - @@img_width, @@buttons_y, @@explore_img.flush([50, 50, 50]))]
    ...
    # ボタン置き場
    # 色が変わるやつは配列になってるので注意
    @@attak_button = [Sprite.new(@@img_margin, @@buttons_y, @@attak_img), Sprite.new(@@img_margin, @@buttons_y, @@attak_img.flush([50, 50, 50]))]
    @@defence_button = [Sprite.new(@@img_margin * 2 + @@img_width, @@buttons_y, @@defence_img), Sprite.new(@@img_margin * 2 + @@img_width, @@buttons_y, @@defence_img.flush([50, 50, 50]))]
